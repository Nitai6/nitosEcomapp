...
> **Source**: borrowed from Aviv Malka's social-content skill (references/reverse-engineering.md). Original framework retained; applies cleanly to theme-page work even though Aviv wrote it for personal/company brand. Credit: avivmalka123/claude-skills.
